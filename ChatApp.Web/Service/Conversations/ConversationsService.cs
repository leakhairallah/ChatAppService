...
public class ConversationsService : IConversationsService
{
    ...
    public async Task<StartConversationResponse> AddConversation(StartConversation conversation)
    {
        ...
        if (createResponse == conversationId)
        {
            ...
            await _messageService.PostMessageToConversation(conversationId, new SendMessageRequest(Guid.NewGuid().ToString(), conversation.FirstMessage.SenderUsername, conversation.FirstMessage.Text), datetime);
    ...
    {
        _logger.LogInformation("Calling conversation participants store...");
